  ...
  return (
    <section id="about">
      ...
      <div className="container2">
        <p>
          We have created an events page as beginner junior developers. This webpage is for Cyprus events only.
            ...
            <div className="kart">
              ...
              <div class="kutu">
                ...
                <form action="https://github.com/ahmetakinsel">
                  <button type="link" class="btn">Github Page</button></form></p>              </div>
          </div>
        </div>
            ...
            <div class="kutu">
              ...
              <p>
                <form action="https://github.com/buseozkan">
                  <button type="link" class="btn">Github Page</button></form></p>
            </div>
          </div>
        </div>
          ...
          <div class="kart">
            ...
            <div class="kutu">
              ...
              <form action="https://github.com/AhmetMustafa">
                <button type="link" class="btn">Github Page</button></form>
                </p>
          </div>
        </div>
      </div>
